...
export default function RegistrationTable() {
  ...
  const search = []
        data&&
            data.forEach((item) => {
                if (item.phone_no.toLowerCase().indexOf(searchList.toLowerCase()) === -1
                && item.classes_number.toLowerCase().indexOf(searchList.toLowerCase()) === -1
    ...
    <Card className="app_card dashboard_card shadow p-4 m-2 mt-2">
        ...
        <Col md={12}>
            <div style={{ display: "flex", flexDirection: "row", marginTop: 30 }}>
                <label className="label_title" style={{color: '#000'}}>Search</label>
                <Col md={12}>
