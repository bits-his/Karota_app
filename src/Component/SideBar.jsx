  ...
  return (
    <div className="">
      <div>
        ...
        <h4 className="mt-4 app_title" style={{ fontSize: "26px", textAlign: 'center', color: 'black', marginBottom: 30}}>
            Karota App
        </h4>  
      </div>
      <div className="link" activeclassName="active">
        ...
        <li className="link_item" onClick={drop}>
          <span>
            <MdDashboard className="icon shadow" />Basic Data{" "}
            {showSubMenu ? (
        ...
        {showSubMenu ? (
          <div className="sub_menu">
            ...
            <li
              ...
              className={`link_item1 ${
                location.pathname === "/varify-payment-with-id" && "active_side_menu"
              }`}
            >
            ...
            <li
              ...
              className={`link_item1 ${
                location.pathname === "/varify-payment-with-qr" && "active_side_menu"
              }`}
            >
