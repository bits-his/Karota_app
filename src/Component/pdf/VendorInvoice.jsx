  ...
  return (
    <Document>
      <Page size={{ width: 200 }} style={styles.body} wrap={false}>
        ...
        <View style={styles.item2}>
          <Text style={{marginRight:5, fontSize:10}}>Transaction Id: {data?.transaction_id}</Text>
          <View style={{ fontWeight: "bold", fontSize: 12 }}>
        ...
        <View>
          <View>
            ...
            <View>
              <Text>{data?.description ? data?.description : `Deposit of N ${formatNumber(data.amount)} to ${data.vendor_name}` }</Text>
            </View>
          </View>
          {/* <View style={styles.item}>
